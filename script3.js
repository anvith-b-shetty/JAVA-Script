document.addEventListener('DOMContentLoaded', function() {
    ...
    function addVideoToList(video, index) {
            ...
            newVideo.innerHTML = `
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <button class="btn btn-secondary save-later" data-index="${index}">Save for Later</button>
                    </div>
                </div>`;
        ...
        newVideo.querySelector('.save-later').addEventListener('click', () => saveForLater(index));
    }
    ...
    function saveForLater(index) {
        ...
        showAlert('Video saved for later!', 'success');
    }
